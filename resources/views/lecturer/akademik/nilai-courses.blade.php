...
@section('content')
<div class="mb-6"><h1 class="font-display text-xl font-semibold">Pilih Mata Kuliah</h1><p class="mt-1 text-sm text-ink/50">Lihat rekap nilai tugas, quiz, dan absensi setiap mahasiswa.</p></div>
...
@empty<div class="sm:col-span-2 xl:col-span-3 rounded-2xl border border-dashed border-line bg-white p-10 text-center text-sm text-ink/50">Belum ada mata kuliah yang Anda ampu.</div>@endforelse
</div>
@endsection
