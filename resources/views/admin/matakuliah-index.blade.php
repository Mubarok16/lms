    ...
    <div class="overflow-x-auto">
        ...
        <table class="w-full text-sm">
                ...
                <tr
                    ...
                    <td class="py-3 px-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            {{-- Edit --}}
                            <button type="button"
                                onclick="bukaModalEdit('{{ $mk->kode_mk }}', '{{ $mk->nama_mk }}', '{{ $mk->prodi_id }}', '{{ $mk->sks }}')"
           ...
           transition-colors">
                            ...
                            {{-- Delete --}}
                            <form action="{{ route('matakuliah.destroy', $mk->kode_mk) }}" method="POST"
...
<script>
    function bukaModalEdit(kodeMk, namaMk, prodiId, sks) {
        document.getElementById('edit_kode_mk').value = kodeMk;
        document.getElementById('edit_nama_mk').value = namaMk;
        document.getElementById('edit_prodi_id').value = prodiId;
        document.getElementById('edit_sks').value = sks;

        document.getElementById('formEdit').action = "{{ url('/admin/matakuliah') }}/" + kodeMk;
