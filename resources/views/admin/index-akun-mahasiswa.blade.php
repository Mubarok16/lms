    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="border-b border-line text-left">
                ...
                <th class="py-3 pr-4 font-medium text-ink/50 font-mono text-xs uppercase tracking-wide">Nama Mahasiswa</th>
                ...
                <th class="py-3 pr-4 font-medium text-ink/50 font-mono text-xs uppercase tracking-wide">No. HP</th>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="7" class="py-6 text-center text-ink/40 text-sm">
