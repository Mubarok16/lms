...
)->middleware(['auth', 'role:admin'])->name('kelas.students.search');

Route::get(
    '/kelas/{kelas}/students',
    [PengajaranController::class, 'searchStudents']
)->middleware(['auth', 'role:admin'])->name('kelas.students');

Route::post(
    '/kelas/{kelas}/peserta',
    [PengajaranController::class, 'tambahPeserta']
)->middleware(['auth', 'role:admin'])->name('kelas.peserta.store');

Route::get(
    '/kelas/{kelas}/peserta',
    [PengajaranController::class, 'daftarPeserta']
)->middleware(['auth', 'role:admin'])->name('kelas.peserta');
